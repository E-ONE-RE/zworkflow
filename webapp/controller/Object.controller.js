...
function fnE(oError){
  ...
  */
/////////////////////////////////////////////////////////////////////  
// evento per azione approve, reject, move
...
({
 ...
 data:oEntry
  ...
  // open pdf sotto icontabbar		
  /*  onOpenDoc: function() {

		var oView = this.getView();
		var oObject = oView.getBindingContext().getObject(),
			sDoc = oObject.ZWfDocument;
				
//    	var sRead = "/PdfdocSet(doc='4500003191')"	;
        var sRead = "/PdfdocSet(doc='" + sDoc + "')"	;
        
    	  var oModel = this.getModel();
    	  var oIconTabBar = this.getView().byId("iconTab2");
		  var oItem = oIconTabBar.getItems()[1];
		  oIconTabBar.setSelectedItem(oItem);
          var oFrame = this.getView().byId("map_iframe");
    	...
    	// oModel.read( sRead, null, null, true, function(oData, oResponse){
    		 ...
    		 oModel.read( sRead,  {success: function(oData, oResponse){
    		 	console.log(oData); console.log(oResponse); 
    		var temp=oResponse.headers; 	
    		var docType=temp["Content-Type"];
			var pdfURL = oData.url;

         oFrameContent.setAttribute("data", "http://10.126.72.12:50040" + pdfURL); 
